...
| [aws_iam_role_policy_attachment.eks_load_balancer_controller_policy_attachment](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/iam_role_policy_attachment) | resource |
...
| <a name="input_oidc"></a> [oidc](#input\_oidc) | OIDC provider URL | `string` | n/a | yes |
