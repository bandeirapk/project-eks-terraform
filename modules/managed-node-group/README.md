...
| <a name="input_private_subnet_1a"></a> [private\_subnet\_1a](#input\_private\_subnet\_1a) | Private subnet in the first availability zone to deploy the EKS cluster | `string` | n/a | yes |
| <a name="input_private_subnet_1b"></a> [private\_subnet\_1b](#input\_private\_subnet\_1b) | Private subnet in the first availability zone to deploy the EKS cluster | `string` | n/a | yes |
